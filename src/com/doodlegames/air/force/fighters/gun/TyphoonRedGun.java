...
public class TyphoonRedGun implements FighterGun {
   ...
   static {
      Vector2[] var0 = new Vector2[]{new Vector2(0.0F + Typhoon.SHOOTPOINT[0].x, 16.0F + Typhoon.SHOOTPOINT[0].y), new Vector2(0.0F + Typhoon.SHOOTPOINT[1].x, 16.0F + Typhoon.SHOOTPOINT[1].y), new Vector2(0.0F + Typhoon.SHOOTPOINT[2].x, 16.0F + Typhoon.SHOOTPOINT[2].y), new Vector2(0.0F + Typhoon.SHOOTPOINT[3].x, 16.0F + Typhoon.SHOOTPOINT[3].y), new Vector2(0.0F + Typhoon.SHOOTPOINT[4].x, 16.0F + Typhoon.SHOOTPOINT[4].y), new Vector2(0.0F + Typhoon.SHOOTPOINT[5].x, 16.0F + Typhoon.SHOOTPOINT[5].y), new Vector2(0.0F + Typhoon.SHOOTPOINT[6].x, 16.0F + Typhoon.SHOOTPOINT[6].y), new Vector2(0.0F + Typhoon.SHOOTPOINT[7].x, 16.0F + Typhoon.SHOOTPOINT[7].y), new Vector2(0.0F + Typhoon.SHOOTPOINT[8].x, 16.0F + Typhoon.SHOOTPOINT[8].y)};
      SHOOTPOINT = var0;
      velX = new float[]{0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F};
      velY = new float[]{550.0F, 550.0F, 550.0F, 550.0F, 550.0F, 550.0F, 550.0F, 550.0F, 550.0F};
      avaGunIndex = new int[][]{{0, 4, 8}, {0, 2, 4, 6, 8}, {0, 1, 2, 3, 4, 5, 6, 7, 8}};
      bulletIndex = new int[][]{{0, 0, 0}, {0, 1, 1, 1, 0}, {0, 1, 1, 2, 2, 2, 1, 1, 0}};
   }

   public TyphoonRedGun(Fighter var1) {
