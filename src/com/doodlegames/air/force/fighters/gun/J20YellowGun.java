...
public class J20YellowGun implements FighterGun {
   ...
   static {
      Vector2[] var0 = new Vector2[]{new Vector2(-16.0F * SIN20 / 1.0F + J20.SHOOTPOINT[0].x, 16.0F * COS20 / 1.0F + J20.SHOOTPOINT[0].y), new Vector2(-16.0F * SIN0 / 1.0F + J20.SHOOTPOINT[1].x, 16.0F * COS0 / 1.0F + J20.SHOOTPOINT[1].y), new Vector2(-16.0F * SIN0 / 1.0F + J20.SHOOTPOINT[2].x, 16.0F * COS0 / 1.0F + J20.SHOOTPOINT[2].y), new Vector2(-16.0F * SIN0 / 1.0F + J20.SHOOTPOINT[3].x, 16.0F * COS0 / 1.0F + J20.SHOOTPOINT[3].y), new Vector2(30.0F, 86.0F), new Vector2(16.0F * SIN0 / 1.0F + J20.SHOOTPOINT[4].x, 16.0F * COS0 / 1.0F + J20.SHOOTPOINT[4].y), new Vector2(16.0F * SIN0 / 1.0F + J20.SHOOTPOINT[5].x, 16.0F * COS0 / 1.0F + J20.SHOOTPOINT[5].y), new Vector2(16.0F * SIN0 / 1.0F + J20.SHOOTPOINT[6].x, 16.0F * COS0 / 1.0F + J20.SHOOTPOINT[6].y), new Vector2(16.0F * SIN20 / 1.0F + J20.SHOOTPOINT[7].x, 16.0F * COS20 / 1.0F + J20.SHOOTPOINT[7].y)};
      SHOOTPOINT = var0;
      float[] var1 = new float[]{-550.0F * SIN20 / 1.0F, -550.0F * SIN0 / 1.0F, -550.0F * SIN0 / 1.0F, -550.0F * SIN0 / 1.0F, 0.0F, 550.0F * SIN0 / 1.0F, 550.0F * SIN0 / 1.0F, 550.0F * SIN0 / 1.0F, 550.0F * SIN20 / 1.0F};
      velX = var1;
      float[] var2 = new float[]{550.0F * COS20 / 1.0F, 550.0F * COS0 / 1.0F, 550.0F * COS0 / 1.0F, 550.0F * COS0 / 1.0F, 550.0F, 550.0F * COS0 / 1.0F, 550.0F * COS0 / 1.0F, 550.0F * COS0 / 1.0F, 550.0F * COS20 / 1.0F};
      velY = var2;
      avaGunIndex = new int[][]{{0, 4, 8}, {0, 3, 5, 8}, {0, 1, 2, 3, 5, 6, 7, 8}};
      bulletIndex = new int[][]{{0, 0, 0}, {1, 1, 1, 1}, {2, 0, 0, 0, 0, 0, 0, 2}};
   }

   public J20YellowGun(Fighter var1) {
