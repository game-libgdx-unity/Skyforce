...
public class Su47YellowGun implements FighterGun {

   private static final float COS0 = 1.0F;
   private static final float COS25 = MathUtils.cosDeg(25.0F);
   ...
   private static final float SIN25 = MathUtils.sinDeg(25.0F);
   ...
   static {
      Vector2[] var0 = new Vector2[]{new Vector2(-16.0F * SIN25 / 1.0F + Su47.SHOOTPOINT[0].x, 16.0F * COS25 / 1.0F + Su47.SHOOTPOINT[0].y), new Vector2(-16.0F * SIN25 / 1.0F + Su47.SHOOTPOINT[1].x, 16.0F * COS25 / 1.0F + Su47.SHOOTPOINT[1].y), new Vector2(-16.0F * SIN25 / 1.0F + Su47.SHOOTPOINT[2].x, 16.0F * COS25 / 1.0F + Su47.SHOOTPOINT[2].y), new Vector2(0.0F + Su47.SHOOTPOINT[3].x, 16.0F + Su47.SHOOTPOINT[3].y), new Vector2(30.0F, 86.0F), new Vector2(0.0F + Su47.SHOOTPOINT[4].x, 16.0F + Su47.SHOOTPOINT[4].y), new Vector2(16.0F * SIN25 / 1.0F + Su47.SHOOTPOINT[5].x, 16.0F * COS25 / 1.0F + Su47.SHOOTPOINT[5].y), new Vector2(16.0F * SIN25 / 1.0F + Su47.SHOOTPOINT[6].x, 16.0F * COS25 / 1.0F + Su47.SHOOTPOINT[6].y), new Vector2(16.0F * SIN25 / 1.0F + Su47.SHOOTPOINT[7].x, 16.0F * COS25 / 1.0F + Su47.SHOOTPOINT[7].y)};
      SHOOTPOINT = var0;
      float[] var1 = new float[]{-550.0F * SIN25 / 1.0F, -550.0F * SIN25 / 1.0F, -550.0F * SIN25 / 1.0F, 0.0F, 0.0F, 0.0F, 550.0F * SIN25 / 1.0F, 550.0F * SIN25 / 1.0F, 550.0F * SIN25 / 1.0F};
      velX = var1;
      float[] var2 = new float[]{550.0F * COS25 / 1.0F, 550.0F * COS25 / 1.0F, 550.0F * COS25 / 1.0F, 550.0F, 550.0F, 550.0F, 550.0F * COS25 / 1.0F, 550.0F * COS25 / 1.0F, 550.0F * COS25 / 1.0F};
      velY = var2;
      avaGunIndex = new int[][]{{0, 4, 8}, {0, 1, 3, 5, 7, 8}, {0, 1, 2, 3, 4, 5, 6, 7, 8}};
      bulletIndex = new int[][]{{0, 0, 0}, {0, 0, 1, 1, 0, 0}, {1, 2, 1, 2, 1, 2, 1, 2, 1}};
   }

   public Su47YellowGun(Fighter var1) {
