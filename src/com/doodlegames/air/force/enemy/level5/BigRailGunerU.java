...
public class BigRailGunerU extends Enemy {

   public static final int DEFAULTHEALTHYDEGREE = 20;
   public static int HEIGHT = 0;
   private static final float TIMEOFPLAYCRASHANIMATION = 1.0F;
   public static final int WIDTH;
   public static TextureAtlas.AtlasRegion canonTextureRegion = Assets_ShareInAllLevel.atlasSharedEnemy.findRegion("alien_big_railguner_u");
   ...
   public BigRailGunerU(World var1, float var2, float var3) {
   ...
   public static void loadResource() {
      canonTextureRegion = Assets_ShareInAllLevel.atlasSharedEnemy.findRegion("alien_big_railguner_u");
   }
