...
public class AlienAeroBoatB extends Enemy {
   ...
   private Clock clockShootingCanon = new Clock(3.0F, 0.4F, (byte)2);
   ...
   static {
      ...
      CANNONPOSITION = new Vector2((12.0F + (float)AlienCannon2.WIDTH / 2.0F) / 1.0F, (61.0F + (float)AlienCannon2.HEIGHT / 2.0F) / 1.0F);
   }

   public AlienAeroBoatB(World var1, float var2, float var3) {
      ...
      this.alienCannon = new AlienCannon2(var1, this.bounds.x + CANNONPOSITION.x, this.bounds.y + CANNONPOSITION.y);
