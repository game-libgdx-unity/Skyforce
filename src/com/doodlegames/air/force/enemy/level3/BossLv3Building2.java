...
public class BossLv3Building2 extends Enemy {
   ...
   private static TextureAtlas.AtlasRegion enemyBroTextureRegion = Assets_level3.atlas_Enemy.findRegion("lv3_boss_building_2_broken");
   private static TextureAtlas.AtlasRegion enemyTextureRegion = Assets_level3.atlas_Enemy.findRegion("lv3_boss_building", 2);
   ...
   static {
      ...
      HEIGHT = var1;
      CANNON1POSITION = new Vector2((64.0F + (float)BossLv3Cannon.WIDTH2 / 2.0F) / 1.0F, (44.0F + (float)BossLv3Cannon.HEIGHT2 / 2.0F) / 1.0F);
      CANNON2POSITION = new Vector2((73.0F + (float)BossLv3Cannon.WIDTH2 / 2.0F) / 1.0F, (53.0F + (float)BossLv3Cannon.HEIGHT2 / 2.0F) / 1.0F);
      CANNON3POSITION = new Vector2((82.0F + (float)BossLv3Cannon.WIDTH2 / 2.0F) / 1.0F, (62.0F + (float)BossLv3Cannon.HEIGHT2 / 2.0F) / 1.0F);
      Rectangle[] var2 = new Rectangle[]{new Rectangle(0.0F, 50.0F, 10.0F, 10.0F), new Rectangle(10.0F, 40.0F, 10.0F, 10.0F), new Rectangle(20.0F, 30.0F, 10.0F, 10.0F), new Rectangle(30.0F, 30.0F, 10.0F, 10.0F), new Rectangle(40.0F, 40.0F, 10.0F, 10.0F), new Rectangle(50.0F, 50.0F, 10.0F, 10.0F), new Rectangle(60.0F, 60.0F, 10.0F, 10.0F), new Rectangle(70.0F, 70.0F, 10.0F, 10.0F), new Rectangle(80.0F, 80.0F, 10.0F, 10.0F), new Rectangle(90.0F, 90.0F, 10.0F, 10.0F), new Rectangle(100.0F, 100.0F, 10.0F, 10.0F), new Rectangle(110.0F, 110.0F, 5.0F, 10.0F)};
      relativeHitRectangles = var2;
      RECNUM = relativeHitRectangles.length;
   }

   public BossLv3Building2(World var1, float var2, float var3, BossLv3 var4) {
      ...
      this.cannon1 = new BossLv3Cannon(var1, this.bounds.x + this.canon1Position.x, this.bounds.y + this.canon1Position.y, false);
      this.cannon2 = new BossLv3Cannon(var1, this.bounds.x + this.canon2Position.x, this.bounds.y + this.canon2Position.y, false);
      this.cannon3 = new BossLv3Cannon(var1, this.bounds.x + this.canon3Position.x, this.bounds.y + this.canon3Position.y, false);
   ...
   private float getInitPositionY() {
      return this.parent.bounds.y + BossLv3.BUILDING2POSITION.y;
   }

   public static void loadResource() {
      enemyTextureRegion = Assets_level3.atlas_Enemy.findRegion("lv3_boss_building", 2);
      enemyBroTextureRegion = Assets_level3.atlas_Enemy.findRegion("lv3_boss_building_2_broken");
   }
