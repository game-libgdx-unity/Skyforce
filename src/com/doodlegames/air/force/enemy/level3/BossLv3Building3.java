...
public class BossLv3Building3 extends Enemy implements EnemyTools.EnemyActionCallBack {
   ...
   private static TextureAtlas.AtlasRegion enemyBroTextureRegion = Assets_level3.atlas_Enemy.findRegion("lv3_boss_building_3_broken");
   private static TextureAtlas.AtlasRegion enemyTextureRegion = Assets_level3.atlas_Enemy.findRegion("lv3_boss_building", 3);
   ...
   static {
      ...
      Vector2[] var2 = new Vector2[]{new Vector2(), new Vector2(), new Vector2()};
      VELBULLET1 = var2;
      Vector2 var3 = new Vector2(VELBULLET2);
      VELBULLET1[0].set(var3);
      VELBULLET1[2].set(-var3.y, var3.x);
      VELBULLET1[1].set(var3.rotate(45.0F));
      BULLET1POSITION = new Vector2(101.0F, 31.0F);
      Vector2[] var7 = new Vector2[]{new Vector2(42.0F, 60.0F), new Vector2(57.0F, 44.0F), new Vector2(72.0F, 28.0F)};
      BULLET2POSITION = var7;
      Rectangle[] var8 = new Rectangle[]{new Rectangle(0.0F, 105.0F, 10.0F, 10.0F), new Rectangle(10.0F, 95.0F, 10.0F, 10.0F), new Rectangle(20.0F, 85.0F, 10.0F, 10.0F), new Rectangle(30.0F, 75.0F, 10.0F, 10.0F), new Rectangle(40.0F, 65.0F, 10.0F, 10.0F), new Rectangle(50.0F, 55.0F, 10.0F, 10.0F), new Rectangle(60.0F, 45.0F, 10.0F, 10.0F), new Rectangle(70.0F, 35.0F, 10.0F, 10.0F), new Rectangle(80.0F, 25.0F, 10.0F, 10.0F), new Rectangle(90.0F, 25.0F, 10.0F, 10.0F), new Rectangle(100.0F, 35.0F, 10.0F, 10.0F), new Rectangle(110.0F, 45.0F, 5.0F, 10.0F)};
      relativeHitRectangles = var8;
      RECNUM = relativeHitRectangles.length;
   }

   public BossLv3Building3(World var1, float var2, float var3, BossLv3 var4) {
   ...
   private float getInitPositionY() {
      return this.parent.bounds.y + BossLv3.BUILDING3POSITION.y;
   }

   public static void loadResource() {
      enemyTextureRegion = Assets_level3.atlas_Enemy.findRegion("lv3_boss_building", 3);
      enemyBroTextureRegion = Assets_level3.atlas_Enemy.findRegion("lv3_boss_building_3_broken");
   }
