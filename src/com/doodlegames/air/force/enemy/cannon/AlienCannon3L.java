...
public class AlienCannon3L extends Enemy {

   public static final Vector2 BULLETPOSITION = new Vector2(4.0F, 10.0F);
   ...
   private static final float VELBULLET = 250.0F;
   public static final int WIDTH;
   public static TextureAtlas.AtlasRegion canonBroTextureRegion = Assets_cannons.atlas_canons.findRegion("alien_canon_3_l_broken");
   public static TextureAtlas.AtlasRegion canonTextureRegion = Assets_cannons.atlas_canons.findRegion("alien_canon_3_l");
   ...
   public AlienCannon3L(World var1, float var2, float var3) {
   ...
   public static void loadResource() {
      canonTextureRegion = Assets_cannons.atlas_canons.findRegion("alien_canon_3_l");
      canonBroTextureRegion = Assets_cannons.atlas_canons.findRegion("alien_canon_3_l_broken");
   }
